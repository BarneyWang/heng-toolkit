package me.heng.tool.origin;

//import com.alibaba.staragent.portal.exception.BackendServiceException;
...
import static com.alibaba.staragent.portal.support.Supports.isEmpty;
import static com.alibaba.staragent.portal.support.Supports.println;

/**
 * Created by wangdi on 16/11/2016.
 *
 * java 8相关的辅助方法
 */
@Deprecated
        ...
        if (f.isDone() || partial) {
            ...
            for (CompletableFuture<List<T>> future : futures) {
                ...
                try {
                    ...
                    if (throwException) {
                        //TODO ee 这里处理得不合理
                        throw new BackendServiceException(e.getMessage());
                    }
                }
            }
            return list;
